        ...
        _goToItemHandler: function(e) {
            ...
            if (mode == "norm") {
                ...
                if (!frame || !frame.contentWindow.scForm) {
					var lang = JSON.parse(document.getElementById("PageData").value).language;
                    var win = parent.parent.window.open("/sitecore/shell/Applications/Content%20editor.aspx?fo=%7b" + mItemId + "%7d&amp;la="+ lang +"&amp;vs=1&amp;we=1");
                    win.focus();
